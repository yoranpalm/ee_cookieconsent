...
if (!defined('COOKIECONSENT_NAME')) {
	define('COOKIECONSENT_AUTHOR', 'Yoran Palm');
...
$config['name']    = COOKIECONSENT_NAME;
$config['version'] = COOKIECONSENT_VERSION;

/* End of file config.php */
/* Location: ./system/user/addons/cookieconsent/config.php */